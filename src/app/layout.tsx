...
export const metadata: Metadata = {
  title: "WeatherHub - Global Weather Intelligence",
  description: "Real-time weather forecasts and meteorological data for major cities worldwide. Get accurate 99.9% weather predictions with instant alerts.",
  keywords: "weather, forecast, global weather, real-time weather, meteorological data, weather app, weather intelligence",
  metadataBase: new URL("https://weatherhub.com"),
  alternates: {
    canonical: "https://weatherhub.com"
  },
  openGraph: {
    title: "WeatherHub - Global Weather Intelligence",
    description: "Track real-time weather conditions across major cities worldwide with the most accurate forecasts available.",
    type: "website",
    siteName: "WeatherHub"
  },
  twitter: {
    ...
    title: "WeatherHub - Global Weather Intelligence",
    description: "Real-time weather forecasts for major cities worldwide"
  },
  robots: {
    index: true,
    follow: true
